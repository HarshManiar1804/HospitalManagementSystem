    ...
    <div id="app">
     ...
     <?php
        ...
        <strong><?php echo $_SESSION['msg']; ?></strong></div>
           ...
           unset($_SESSION['msg']);
           if(isset($_SESSION['errins']))
           {
            ?>
              <div class="alert" style="background: red">
        <span class="closebtn" onclick="this.parentElement.style.display='none';">&times;</span> 
        <strong">Something went wrong in data insert.... please enter valid data......</strong></div>
            
          
           <?php
           unset($_SESSION['errins']);
            }
           ?>
      ...
      <div class="row">
        ...
        <div class="col col-sm-6 col-md-6 col-lg-4 col-xl-5">
          <div class="card card-primary">
            ...
            <!--   <div class="form-group">
                <label for="inputName">Doctor Specialization ID</label>
                <input type="number" name="DoctorSpecialicationID" id="inputName" class="form-control" required="required">
              </div> -->
